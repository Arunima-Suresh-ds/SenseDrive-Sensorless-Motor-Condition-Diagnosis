# SenseDrive-Sensorless-Motor-Condition-Diagnosis-using-ML
![Python](https://img.shields.io/badge/Python-3.8+-black?style=flat&logo=python)
![Use Case](https://img.shields.io/badge/Use%20Case-Sensorless%20Drive%20Diagnosis-blue)
![Model](https://img.shields.io/badge/Model-Random%20Forest-orange)
![Evaluation](https://img.shields.io/badge/Evaluation-Cross--Validated-success)

SenseDrive applies machine learning to classify electric motor operating conditions using electrical signal data, enabling sensorless, cost-effective diagnostics for industrial predictive maintenance.
...
Typical Workflow:
Electrical signals are continuously collected from motor drives
Features are extracted in real time
The trained model predicts the motor operating condition
Predictions are mapped to risk levels (normal, warning, abnormal)
Engineers use these insights to plan maintenance and reduce downtime
Final Conclusion
